...
module Decidim
  describe Decidim::Devise::RegistrationsController, type: :controller do
    ...
    describe "GET new" do
      ...
      it "renders the custom form" do
        get :new
        expect(response).to render_template("decidim/devise/registrations/new")
        expect(@controller.instance_variable_get(:@form).textcaptcha_question).to eq("99+1")
      end
    end
  end
end
